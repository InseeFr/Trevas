 ...
 *
 * <p>See package {@linkplain fr.insee.vtl.engine.semantics.attribute} documentation for a warning
 * on revisiting this propagation rule if the spec or language evolves.
 */
