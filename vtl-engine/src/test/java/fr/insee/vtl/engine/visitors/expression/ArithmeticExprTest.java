  ...
  public void testArithmeticExpr() throws ScriptException {
    ...
    assertThat(((Dataset) res).getDataAsMap())
        .containsExactlyInAnyOrder(
            Map.of("id", "Hadrien", "long1", 1500L, "double1", 1L),
            Map.of("id", "Nico", "long1", 400L, "double1", 27L),
            Map.of("id", "Franck", "long1", 10000L, "double1", -1L));
    assertThat(((Dataset) res).getDataStructure().get("long1").getType()).isEqualTo(Long.class);
    assertThat(((Dataset) res).getDataStructure().get("double1").getType()).isEqualTo(Long.class);
    ...
    assertThat(((Dataset) res).getDataAsMap())
        .containsExactlyInAnyOrder(
            Map.of("id", "Hadrien", "long1", 0L, "double1", 1L),
            Map.of("id", "Nico", "long1", 1L, "double1", 6L),
            Map.of("id", "Franck", "long1", 1L, "double1", -1L));
    assertThat(((Dataset) res).getDataStructure().get("long1").getType()).isEqualTo(Long.class);
    assertThat(((Dataset) res).getDataStructure().get("double1").getType()).isEqualTo(Long.class);
  }
