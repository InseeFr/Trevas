...
class MembershipExecutorTest {
  ...
  void measureMembershipOnSampleDataset() {
    ...
    DatasetExpression result = MembershipExecutor.execute(engine, ds, "long1");
  ...
  void identifierMembershipCreatesIntVar() {
    ...
    DatasetExpression result = MembershipExecutor.execute(engine, expression, "code");
    var resolved = result.resolve(Map.of());
  ...
  void attributeMembershipCreatesStringVarAndKeepsViralAttribute() {
    ...
    DatasetExpression expression = DatasetExpression.of(ds, POS);
    DatasetExpression result = MembershipExecutor.execute(engine, expression, "attr");
    var resolved = result.resolve(Map.of());
