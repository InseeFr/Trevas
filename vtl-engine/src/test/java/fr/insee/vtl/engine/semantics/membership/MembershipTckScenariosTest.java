...
class MembershipTckScenariosTest {
  ...
  void ds1MeasureMembershipEx1() {
    var result = MembershipExecutor.execute(engine, ds1, "Me_1").resolve(Map.of());
  ...
  void ds1IdentifierMembershipEx2() {
    var result = MembershipExecutor.execute(engine, ds1, "Id_1").resolve(Map.of());
  ...
  void ds1AttributeMembershipEx3() {
    var result = MembershipExecutor.execute(engine, ds1, "At_1").resolve(Map.of());
  ...
  void ds2MeasureMembershipKeepsViralEx4() {
    var result = MembershipExecutor.execute(engine, ds2, "Me_1").resolve(Map.of());
  ...
  void ds2IdentifierMembershipKeepsViralEx5() {
    var result = MembershipExecutor.execute(engine, ds2, "Id_1").resolve(Map.of());
  ...
  void ds2ViralAttributeMembershipEx6() {
    var result = MembershipExecutor.execute(engine, ds2, "At_1").resolve(Map.of());
