...
public class SDMXVTLWorkflowTest {
  ...
  void testGetEmptyDataset() {
    ...
    assertThat(result.get("BPE_CENSUS_NUTS3_2021").getDataStructure())
        .isEqualTo(
    ...
    assertThat(result.get("BPE_MUNICIPALITY").getDataStructure())
        .isEqualTo(
            new Structured.DataStructure(
                List.of(
                    new Structured.Component(
    ...
    assertThat(result.get("BPE_NUTS3").getDataStructure())
        .isEqualTo(
            new Structured.DataStructure(
                List.of(
                    new Structured.Component("TIME_PERIOD", String.class, Dataset.Role.IDENTIFIER),
