...
public class PROV {
  ...
  * Defines PROV Classes
  ...
  public static final Resource InstantaneousEvent =
      model.createResource(uri + "InstantaneousEvent");
  ...
  * Defines PROV Properties
  ...
  public static final Property qualifiedInfluence =
      model.createProperty(uri + "qualifiedInfluence");
  public static final Property qualifiedGeneration =
      model.createProperty(uri + "qualifiedGeneration");
  public static final Property qualifiedDerivation =
      model.createProperty(uri + "qualifiedDerivation");
  public static final Property qualifiedPrimarySource =
      model.createProperty(uri + "qualifiedPrimarySource");
  public static final Property qualifiedQuotation =
      model.createProperty(uri + "qualifiedQuotation");
  public static final Property qualifiedRevision = model.createProperty(uri + "qualifiedRevision");
  public static final Property qualifiedAttribution =
      model.createProperty(uri + "qualifiedAttribution");
  public static final Property qualifiedInvalidation =
      model.createProperty(uri + "qualifiedInvalidation");
  ...
  public static final Property qualifiedCommunication =
      model.createProperty(uri + "qualifiedCommunication");
  public static final Property qualifiedAssociation =
      model.createProperty(uri + "qualifiedAssociation");
  public static final Property qualifiedEnd = model.createProperty(uri + "qualifiedEnd");
  public static final Property qualifiedDelegation =
      model.createProperty(uri + "qualifiedDelegation");
