...
| 17 | UDF `define operator` + call | **PR-39:** walk body at the call site; map formals → {@code varID} args; expression edges without {@code op=<name>} (same as a substituted scalar). Unused formals omitted. |
