...
Trevas on the VTL formal grammar expressed with [EBNF](https://fr.wikipedia.org/wiki/Extended_Backus-Naur_Form). The reference is the version 2.1 upgrade published in July 2024 [on the SDMX web site](https://github.com/sdmx-twg/vtl/tree/master/v2.1/src/main/antlr4/org/sdmx/vtl).
