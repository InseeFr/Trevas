...
Trevas s'appuie sur la grammaire formelle de VTL exprimée sous forme [EBNF](https://fr.wikipedia.org/wiki/Extended_Backus-Naur_Form). La référence est l'upgrade de la version 2.1 publiée en juillet 2024 [sur le site web SDMX](https://github.com/sdmx-twg/vtl/tree/master/v2.1/src/main/antlr4/org/sdmx/vtl).
